...
## extract all values to each species least cost path

### 2020
```{r}
extract_2020 <- lapply(c(5,49), function(x){ # c(1:81)
...
# joint least cost paths of all species for 2020
...
```{r}
extract_2050 <- lapply(c(5,49), function(x){ # c(1:81)
...
# joint least cost paths of all species for 2050
...
```{r}
extract_2080 <- lapply(c(5,49), function(x){ # c(1:81)
...
# joint least cost paths of all species for 2080
...
These data sets were then filtered with the 75% cut off procedure in a GIS. Script 6 starts with the 75% cut off data sets per time slice. 
